...
{
    public class SellingModel : PageModel
    {
        ...
        public SellingModel(ApplicationDbContext context, IAuctionRepository auctionRepository,UserManager<EAuction.Models.User> userManager)
        {
        ...
        public async Task OnGetAsync(int? pageIndex)
        {
            ...
            AuctionsIQ = _auctionRepository.GetAuctions().Where(a=>a.Seller == user && a.EndDate < DateTime.UtcNow);
